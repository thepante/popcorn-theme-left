...
## Modernleft theme
Theme for Popcorn Time that moves the window buttons to the left, mainly. Made and tested only on Linux. Should be good on Windows too.
...
From terminal, assuming your app path is `/opt/popcorntime`, one line:
```bash
